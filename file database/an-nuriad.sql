...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 23 Nov 2024 pada 18.45
...
INSERT INTO `pendaftaran_siswa` (`id`, `nama_siswa`, `nama_panggilan`, `tanggal_lahir`, `tempat_lahir`, `agama`, `jumlah_saudara`, `anak_ke`, `jk_anak`, `nama_ibu`, `tempat_lahir_ibu`, `agama_ibu`, `telepon_ibu`, `pekerjaan_ibu`, `pendidikan_ibu`, `alamat_ibu`, `nama_ayah`, `tempat_lahir_ayah`, `agama_ayah`, `telepon_ayah`, `pekerjaan_ayah`, `pendidikan_ayah`, `alamat_ayah`, `status`, `status_konfirmasi`) VALUES
(1, 'rere', 'rururu', '2024-11-24', 'bekasi', 'Islam', 2, 1, '', 'Raihan yasykur', 'bekasi, 20 september 1999', 'Kristen Protestan', '085157204233', 'maining', 'SMP', 'Kp.babakan Rt004 Rw005 Desa Mekarjaya', 'saia', 'duren, 20 september 1999', 'Kristen Protestan', '231212313213', 'maining', 'SMA', 'Kp.babakan Rt004 Rw005 Desa Mekarjaya', 'belum_terkonfirmasi', 'belum');
