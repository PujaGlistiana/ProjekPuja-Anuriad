...
if (isset($_POST['kirim'])) {
    ...
    if (mysqli_query($conn, $sqlInsert)) {
        ...
        $folderName = "siswa/" . str_replace(' ', '_', $nama_anak) . "_" . str_replace('-', '', $tanggal_lahir);
        ...
        file_put_contents("$folderName/readme.txt", "Data siswa $nama_anak telah disimpan di folder ini.");

        echo "<script>alert('Data berhasil disimpan dan folder telah dibuat.');window.location.href='dashboard.php';</script>";
    } else {
    ...
    <script>
        function validateForm(event) {
            ...
            if (!isValid) {
                ...
                alert('Semua data wajib diisi ya. Periksa kembali form.');
